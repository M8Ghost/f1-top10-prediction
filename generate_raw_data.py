...
def build_feature_tables(race_results: pd.DataFrame) -> dict[str, pd.DataFrame]:
            ...
            pit_rows.append(
                {
                    "race_id": race,
                    "driver_id": driver_id,
                    "races_with_pit_data_previous_3": 0,
                    "avg_pit_stop_time_previous_3_races": 0.0,
                    "best_pit_stop_time_previous_3_races": 0.0,
                    "worst_pit_stop_time_previous_3_races": 0.0,
                    "total_pit_stops_previous_3_races": 0,
                    "avg_total_pit_time_previous_3_races": 0.0,
                    "avg_pit_stop_rank_previous_3_races": 0.0,
                }
            )
...
def main() -> None:
    ...
    feature_tables = build_feature_tables(race_results)
